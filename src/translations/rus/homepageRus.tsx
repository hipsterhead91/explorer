  ...
  mainBlock:
    <div className="homepage__block">
      ...
      <ul className="homepage__list">
        ...
        <li className="homepage__list-element"><span className="homepage__bold">Сайт спроектирован в парадигме "desktop first"</span> — я почти не пытался адаптировать его для мобильных устройств, так как по-настоящему хороший дизайн требует много времени, а в данном проекте вёрстка не была моим основным приоритетом. Возможно, я исправлю это позже, но пока что <span className="homepage__bold">рекомендую смотреть приложение с ПК или хотя бы планшета</span>. Прошу прощения за данное неудобство.</li>
      </ul>
    </div>,
