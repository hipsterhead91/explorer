      ...
      <div className="homepage__container section-limiter">
        ...
        <div className="homepage__block">
          ...
          <ul className="homepage__list">
            ...
            <li className="homepage__list-element">Also, it shows information about token price in USD taken from <a className="homepage__link" href="https://www.coingecko.com/" target="_blank">CoinGecko</a> via their own API (the second one in this project). The few tokens are not presented on CoinGecko, so "no data" plate will be shown.</li>
            ...
            <li className="homepage__list-element">If selected chain has active proposals, you can check them in the corresponding section (this feature is work in progress).</li>
