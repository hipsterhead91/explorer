  ...
  mainBlock:
    <div className="homepage__block">
      ...
      <ul className="homepage__list">
        ...
        <li className="homepage__list-element"><span className="homepage__bold">This site is made in "desktop first" paradigm</span> — I almost didn't try to make it adaptive for mobile devices, because really good design requires unacceptable amount of time, and that wasn't my top priority in this project. I may do it later, but now please <span className="homepage__bold">watch it with your PC</span> (or at least tablet), and sorry for this inconvenience.</li>
      </ul>
    </div>,
